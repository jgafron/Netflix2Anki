...
from .main_window import LANGUAGE_MAP
...
class SettingsWindow:
    ...
    def create_widgets(self):
        ...
        tk.Label(self.top, text="OpenAI Model:").pack(pady=5)
        self.model_var = tk.StringVar(value=self.config.get('Settings', 'model', fallback='gpt-4'))
        self.model_dropdown = ttk.Combobox(self.top, textvariable=self.model_var, state='readonly', values=[
